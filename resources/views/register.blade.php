            ...
            <div class="login-card">
                ...
                <form action="{{route('register.post')}}" method="POST" novalidate>
                    ...
                    <div class="mb-3">
                        ...
                        <input id="name" name="name" type="text" class="form-control" placeholder="Masukkan nama lengkap" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input id="kontak" name="kontak" type="text" class="form-control" placeholder="Contoh: 628123456789" required>
                    </div>
                    <div class="mb-3">
